...
# export PLATFORM_REPO_PATHS=/tools/Xilinx/Vitis/2022.1/base_platforms/xilinx_zcu102_base_202210_1/
export PLATFORM_REPO_PATHS=/tools/Xilinx/Vitis/2022.2/base_platforms/xilinx_zcu104_base_202220_1/
...
cd ../package
time1=$(date)
echo "build package start time at $time1"
make all > build.log 2>&1
time1=$(date)
